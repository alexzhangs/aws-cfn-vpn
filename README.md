...
* Shadowsocks-libev, multi nodes with a center user management is supported by deploying this stack
  multi times.
* L2TPD, the user management is saperate from shadowsocks-manager.
...
and L2TPD, then 1 domain name with 1 DNS record will work for all
services above.
...
1. With the method 1 above, 3 domain names needed.
    ...
    point to the public IP of the L2TPD node.
